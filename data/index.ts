...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building server side solutions",
...
export const workExperience = [
  {
    ...
    desc: "Assisted in the apis and server-side implementatons of a dictionary app .",
    className: "md:col-span-2",
    thumbnail: "/exp1.svg",
  },
  {
    id: 2,
    title: "Web App Dev - Chris Tech",
    desc: "Designed and developed a Patient Management System with Next.js | Twilio, TypeScript, TailwindCSS.",
